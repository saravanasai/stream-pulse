...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/stream-pulse.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/stream-pulse)
...
```bash
php artisan vendor:publish --tag="stream-pulse-migrations"
php artisan migrate
```
...
```php
$streamPulse = new StreamPulse\StreamPulse();
echo $streamPulse->echoPhrase('Hello, StreamPulse!');
```
